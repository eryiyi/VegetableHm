...
import com.Lbins.VegetableHm.gaode.TTSController;
...
public class GPSNaviActivity extends BaseActivity implements AMapNaviListener, AMapNaviViewListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mStartLatlng = new NaviLatLng(Double.valueOf(VegetablesApplication.lat), Double.valueOf(VegetablesApplication.lng));
